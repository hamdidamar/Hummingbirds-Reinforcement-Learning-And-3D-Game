...
public class Flower : MonoBehaviour
{
    ...
    public Color fullFlowerColor = new Color(1f, 0f, .3f); //red
    ...
    /// <summary>
    /// The amount of the nectar remaining in the flower
    /// </summary>
    public float NectarAmount { get; private set; }

    /// <summary>
    /// Whether the flower has my nectar remaining
    /// </summary>
    ...
    {
        // Track how much nectar was successfully taken (cannot take more than is avaible)
        ...
        if (NectarAmount <= 0)
        {
            ...
            // Change the flower color to inficate that it is empty
    ...
    public void ResetFlower()
    {
        ...
        //Change the flower color to inficate that it is full
